...
public class OutputModelTest {
    ...
    public void shouldReturnFormatProductArray() throws Exception {
        ...
        String barcodeInput = "[" +
                ...
                "    'ITEM000005'\n" +
                "]";
        String test = outputModel.getFormatProductArrray(transformModel.transformBarcodeAndNumberToBarcodeAndFormat(transformModel.transformInputToBarcodeAndNumber(barcodeInput)));
