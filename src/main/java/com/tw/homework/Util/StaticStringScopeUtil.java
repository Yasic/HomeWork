...
public class StaticStringScopeUtil {
    ...
    public static final String MONEYUNITTEXT = "(元)";
    public static final String SUBTOTALTEXT = "小计：";
    public static final String SAVETEXT = "节省";
    public static final String TOTALTEXT = "总计：";
